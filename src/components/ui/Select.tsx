      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <select
            ...
            id={inputId}
            className={cn(
              'h-11 w-full appearance-none rounded-control border border-steel-200 bg-white pl-3.5 pr-10 text-sm text-navy-900 transition-colors duration-180 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 focus-visible:border-navy-500',
