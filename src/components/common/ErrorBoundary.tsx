    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-steel-50 px-4">
        <div className="w-full max-w-md rounded-card border border-steel-100 bg-white p-8 text-center shadow-elevation-2">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-card bg-amber-50 text-amber-600">
          ...
          {import.meta.env.DEV && (
            <pre className="mt-4 overflow-x-auto rounded-control bg-steel-50 p-3 text-left text-xs text-steel-600">
              {error.message}
            </pre>
          )}
          <button
