...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-navy-950 pb-32 sm:pb-40 lg:pb-48">
        ...
        <div className="container-page relative pt-20 sm:pt-28">
          <div className="max-w-2xl animate-fade-up">
            ...
            <h1 className="mt-6 text-5xl font-extrabold leading-[1.1] text-white sm:text-6xl">
      ...
      {/* HERO STATS — quick, honest facts about the service */}
      <div className="container-page mt-10 sm:mt-12">
        <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {HERO_STATS.map((stat) => (
            <div
              key={stat.value}
              className="flex items-center gap-4 rounded-2xl border border-steel-100 bg-white p-5 shadow-elevation-1"
            >
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-accent-50 text-accent-600">
                <stat.icon className="h-5 w-5" />
              </div>
              <div>
                <dt className="text-base font-extrabold text-navy-900">{stat.value}</dt>
                <dd className="mt-0.5 text-sm leading-snug text-steel-500">{stat.label}</dd>
              </div>
            </div>
          ))}
        </dl>
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((service, i) => (
            <Link
              ...
              className="group relative flex flex-col overflow-hidden rounded-2xl border border-steel-100 bg-white shadow-elevation-2 transition-all duration-300 hover:-translate-y-1 hover:shadow-elevation-3"
              style={i === 0 ? { gridColumn: 'span 1' } : undefined}
            >
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-dashed border-steel-200 bg-steel-50/60 p-6 text-center">
            ...
            <Link to="/contact" className="mt-4 inline-flex items-center justify-center gap-1.5 text-sm font-bold text-accent-600">
      ...
      <section className="relative overflow-hidden bg-navy-900 py-20 text-white sm:py-28">
        <div className="pointer-events-none absolute inset-0 bg-route-dots bg-[size:22px_22px] opacity-[0.07]" />
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 hidden w-56 rounded-2xl border border-steel-100 bg-white p-5 shadow-elevation-3 sm:block">
              ...
              <p className="mt-1 text-sm font-semibold text-steel-500">Countries we connect, with one route we know inside out</p>
            </div>
          </div>
          <div>
            ...
            <Link to="/about" className="mt-7 inline-flex items-center gap-1.5 text-sm font-bold text-navy-800 hover:text-accent-600">
      ...
      {/* CONTACT TEASER */}
      <section className="relative overflow-hidden bg-gradient-to-br from-navy-800 to-navy-950 py-20 text-white sm:py-24">
