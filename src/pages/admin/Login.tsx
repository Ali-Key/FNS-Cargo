    ...
    <div className="min-h-screen bg-white lg:grid lg:grid-cols-2">
      ...
      <div className="relative hidden overflow-hidden bg-navy-950 lg:block">
        ...
        <div className="relative flex h-full flex-col justify-end p-16">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary-400">FNS Cargo Operations</p>
          <h2 className="mt-5 max-w-lg text-5xl font-extrabold leading-tight text-white">
            Connecting Somalia with global logistics.
          </h2>
          <p className="mt-5 max-w-lg text-lg leading-relaxed text-gray-300">
            Manage shipments, monitor tracking updates, and keep every delivery moving securely.
          </p>
        </div>
      </div>
      ...
      <div className="flex min-h-screen flex-col px-6 py-8 sm:px-10 lg:px-16">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-md">
            <h1 className="text-4xl font-extrabold tracking-tight text-navy-900">Sign in</h1>
            <p className="mt-3 text-sm leading-relaxed text-text-secondary">
              Access the FNS Cargo operations portal to manage shipments, tracking, and customers.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5" noValidate>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-[2.35rem] rounded-lg p-1 text-steel-400 hover:text-navy-900"
                >
            ...
            <div className="mt-6 flex items-start gap-2.5 rounded-xl border border-primary-200 bg-primary-50 px-4 py-3">
        ...
        <div className="flex items-center justify-between text-xs text-steel-400">
          <span>© {new Date().getFullYear()} FNS Cargo</span>
          <Link to="/" className="flex items-center gap-1 font-semibold hover:text-navy-900">
