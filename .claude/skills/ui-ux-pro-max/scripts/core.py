...
CSV_CONFIG = {
    ...
    "color": {
        ...
        "output_cols": ["Product Type", "Primary", "On Primary", "Secondary", "On Secondary", "primary", "On primary", "Background", "Foreground", "Card", "Card Foreground", "Muted", "Muted Foreground", "Border", "Destructive", "On Destructive", "Ring", "Notes"]
    },
    "chart": {
        "file": "charts.csv",
...
def _domain_keywords():
    ...
    _DOMAIN_KEYWORDS = {
        "color": ["color", "palette", "hex", "#", "rgb", "token", "semantic", "primary", "destructive", "muted", "foreground"],
